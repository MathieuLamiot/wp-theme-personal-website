    ...
    <div class="twp-article-wrapper <?php echo esc_attr($div_class); ?>">
        ...
        <div class="twp-business-article secondary-bgcolor">
            ...
            <div class="entry-content">
                <div class='twp-content-image twp-content-gallery'>
                    <?php
                    if (has_block('core/gallery', get_the_content())) { ?>
                        <div class="entry-gallery">

                            <?php business_insights_print_first_instance_of_block('core/gallery', get_the_content()); ?>
                ...
                <div class="twp-content-details">
                    ...
                    if (!empty($read_more_text)) {
                        ?><a href="<?php the_permalink(); ?>"
                             class="btn-link btn-link-primary"><?php echo esc_html($read_more_text); ?><i
                                class="ion-ios-arrow-right"></i></a><?php
                    } ?>
                </div>
            </div><!-- .entry-content -->
        </div>
